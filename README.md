...
`data/catalog.json`에 **제품 301개, 부품 106개, 판매 항목 106개, 적용·제외 근거 380개**를 수록했습니다. 18개 제품 브랜드, 13개 분야입니다. 전체 모델뿐 아니라 제조사 적용 목록의 계열과 자전거 캘리퍼 모델도 포함하며 전 세계 제품 수를 뜻하지 않습니다.
...
- `npm test`: 관찰 계약·게이트웨이·근거 판정·HTTP 서버·카탈로그 검색 테스트 64개 통과. 자동 테스트에서 유료 AI를 호출하지 않습니다.
