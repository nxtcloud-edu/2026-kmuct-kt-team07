...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-86%20passed-22C55E" alt="Tests" />
</p>
...
| **모델명 없는 사진 추정** | 모델 코드를 읽지 못해도 제품 종류·브랜드 로고·코드 조각으로 후보를 정렬해 유력한 제품을 맨 위에 `사진으로 추정` 표시와 근거를 달아 보여 줍니다. 확정은 사용자가 합니다. |
